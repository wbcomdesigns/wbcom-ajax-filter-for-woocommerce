...
<div class="wb-ajax-filter-ajaxsearch-filters-container" style="display: flex;">
	...
	<?php if ( isset( $wb_ajax_filter_search_content_settings['cf_name'] ) && '' !== $wb_ajax_filter_search_content_settings['cf_name'] ) : ?>
		<div class="wb-ajax-filter-ajaxsearchform-input">
			<input type="text" id="wb_ajax_search_custom_field" placeholder="<?php echo esc_attr( $wb_ajax_filter_search_content_settings['custom_field_label'] ); ?>" name="meta_<?php echo esc_attr( $wb_ajax_filter_search_content_settings['cf_name'] ); ?>" value="<?php echo ( isset( $_REQUEST[ 'meta_' . $wb_ajax_filter_search_content_settings['cf_name'] ] ) && '' !== $_REQUEST[ 'meta_' . $wb_ajax_filter_search_content_settings['cf_name'] ] ) ? esc_attr( sanitize_text_field( wp_unslash( $_REQUEST[ 'meta_' . $wb_ajax_filter_search_content_settings['cf_name'] ] ) ) ) : ''; //phpcs:ignore?>">
		</div>	
	<?php endif; ?>
