...
<div class="wb-ajax-filter-container-single filter-orderby">
	...
	<div class="wb-ajax-panel" style="<?php echo ( $toggle_enabled && 'closed' === $filters['toggle_style'] ) ? 'display:none' : ''; ?>">
		...
		<a href="javascript:void(0)" class="wb-ajax-clear-single-filter" data-filter="orderby" style="<?php echo ( ! isset( $_GET['orderby'] ) ) ? esc_attr( $clear_style ) : ''; ?>"><?php esc_html_e( 'Clear', 'wb-ajax-filter' ); ?></a>
		<?php } ?>
