...
<div class="wb-ajax-filter-container-single filter-price-slider">
	...
	<a class="wb-ajax-clear-single-filter button" data-filter="min_price,max_price" style="<?php echo ( ! isset( $_GET['min_price'] ) ) ? esc_attr( $clear_style ) : ''; ?>"><?php esc_html_e( 'Clear', 'wb-ajax-filter' ); ?></a>
	<?php } ?>
