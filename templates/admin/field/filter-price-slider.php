...
<div class="wb-ajax-filter-toggle-content-row wb-price-slider-toggle" style="<?php echo esc_attr( $style ); ?>">
	...
	<div class="wb-ajax-filter-field-wrapper wb-ajax-filter-select-field-wrapper">
		<input type="number" name="filters[price_slider_min]" class="wb-input wb-filter-type-price-slider" value="" min="0" step="0.01">
	</div>
...
<div class="wb-ajax-filter-toggle-content-row wb-price-slider-toggle" style="<?php echo esc_attr( $style ); ?>">
	...
	<div class="wb-ajax-filter-field-wrapper wb-ajax-filter-number-field-wrapper">
		<input type="number" name="filters[price_slider_max]" class="wb-input wb-filter-type-price-slider" value="" min="0" step="0.01">
	</div>
...
<div class="wb-ajax-filter-toggle-content-row wb-price-slider-toggle" style="<?php echo esc_attr( $style ); ?>">
	...
	<div class="wb-ajax-filter-field-wrapper wb-ajax-filter-number-field-wrapper">
		<input type="number" name="filters[price_slider_step]" class="wb-input wb-filter-type-price-slider" value="" min="0.01" step="0.01">
	</div>
