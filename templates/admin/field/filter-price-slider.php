...
if ( empty( $filters ) || ( ! empty( $filters ) && 'price_slider' === $filters['type'] ) ) {
	?>
<div class="wb-ajax-filter-toggle-content-row wb-price-slider-toggle">
	...
	<div class="wb-ajax-filter-field-wrapper wb-ajax-filter-select-field-wrapper">
		<input type="number" name="filters[price_slider_min]" class="" value="" min="0" step="0.01">
	</div>
...
<div class="wb-ajax-filter-toggle-content-row wb-price-slider-toggle">
	...
	<div class="wb-ajax-filter-field-wrapper wb-ajax-filter-number-field-wrapper">
		<input type="number" name="filters[price_slider_max]" class="" value="" min="0" step="0.01">
	</div>
...
<div class="wb-ajax-filter-toggle-content-row wb-price-slider-toggle">
	...
	<div class="wb-ajax-filter-field-wrapper wb-ajax-filter-number-field-wrapper">
		<input type="number" name="filters[price_slider_step]" class="" value="" min="0.01" step="0.01">
	</div>
