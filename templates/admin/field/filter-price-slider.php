...
<div class="wb-ajax-filter-toggle-content-row wb-price-slider-toggle" style="<?php echo esc_attr( $style ); ?>">
	...
	<div class="wb-ajax-filter-field-wrapper wb-ajax-filter-select-field-wrapper">
		<input type="number" name="filters[price_slider_min]" class="wb-input wb-filter-type-price-slider" value="<?php echo ( isset( $filters['price_slider_min'] ) ) ? esc_attr( $filters['price_slider_min'] ) : 0; ?>" min="0" step="10">
	</div>
...
<div class="wb-ajax-filter-toggle-content-row wb-price-slider-toggle" style="<?php echo esc_attr( $style ); ?>">
	...
	<div class="wb-ajax-filter-field-wrapper wb-ajax-filter-number-field-wrapper">
		<input type="number" name="filters[price_slider_max]" class="wb-input wb-filter-type-price-slider" value="<?php echo ( isset( $filters['price_slider_max'] ) ) ? esc_attr( $filters['price_slider_max'] ) : 0; ?>" min="0" step="10">
	</div>
...
<div class="wb-ajax-filter-toggle-content-row wb-price-slider-toggle" style="<?php echo esc_attr( $style ); ?>">
	...
	<div class="wb-ajax-filter-field-wrapper wb-ajax-filter-number-field-wrapper">
		<input type="number" name="filters[price_slider_step]" class="wb-input wb-filter-type-price-slider" value="<?php echo ( isset( $filters['price_slider_step'] ) ) ? esc_attr( $filters['price_slider_step'] ) : 0; ?>" min="0" step="10">
	</div>
