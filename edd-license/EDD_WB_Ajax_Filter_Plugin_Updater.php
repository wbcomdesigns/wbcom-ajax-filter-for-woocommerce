 ...
 * @version 1.6.15
 */
class EDD_WB_Ajax_Filter_Plugin_Updater {
	...
	public function show_changelog() {
		...
		if ( ! current_user_can( 'update_plugins' ) ) {
			wp_die( esc_html__( 'You do not have permission to install plugin updates', 'wb-ajax-filter' ), esc_html_e( 'Error', 'wb-ajax-filter' ), array( 'response' => 403 ) );
		}
