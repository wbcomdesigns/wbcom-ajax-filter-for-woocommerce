...
<div class="wbcom-admin-title-section">
	<h3 class="wp-heading-inline"><?php esc_html_e( 'Search Options', 'wb-ajax-filter' ); ?></h3>
	 </div>
				...
				<div class="wbcom-settings-section-wrap">
				 ...
				 <div class="wbcom-settings-section-options">
						<label>
							...
							<span class="description"><?php esc_html_e( 'Extend search in the content of the product', 'wb-ajax-filter' ); ?></span>
						</label><br>
				 </div>
				 </div>
				 ...
				 <div class="wbcom-settings-section-options">
						<label>
							...
							<span class="description"><?php esc_html_e( 'Extend search in product categories', 'wb-ajax-filter' ); ?></span>
						</label><br>
					 </div>
				</div>
				<div class="wbcom-settings-section-wrap">
					...
					<div class="wbcom-settings-section-wrap">
					  <div class="wbcom-settings-section-options-heading">
						...
						<p class="wb-ajax-filter-option-desc"><?php esc_html_e( 'Extend search in author', 'wb-ajax-filter' ); ?></p>
