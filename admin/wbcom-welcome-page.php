...
<div class="wbcom-tab-content">
	<div class="wbcom-welcome-main-wrapper">
		<div class="wbcom-welcome-head">
			<h2 class="wbcom-welcome-title"><?php esc_html_e( 'Wbcom Designs - Woo Ajax Filter', 'wb-recaptcha' ); ?></h2>
			<p class="wbcom-welcome-description"><?php esc_html_e( 'WB Ajax Filter for WooCommerce plugin allows users to “Filter product without page load”.', 'wb-ajaxfilter' ); ?></p>
			<p class="wbcom-welcome-description"><?php esc_html_e( 'This plugin provide user to add filter like Category, size, color, attribute, etc..', 'wb-ajaxfilter' ); ?></p>
