        ...
        <div class="reign-demos-wrapper wbcom-themes-inner-wrapper">
                ...
                <div class="wbcom-demo-importer">
                    <div class="container">
                        <div class="wbcom-image-wrapper">
                            <img src="<?php echo esc_url( plugin_url . 'admin/wbcom/assets/imgs/reign.jpg' ); ?>" alt="Avatar" class="image" style="width:100%">
                        </div>
                        <div class="wbcom-demo-title">
                            ...
                            <ul class="wbcom_theme_features_list">
                                ...
                                <li><?php esc_html_e('Multiple Group Directory Layout', 'buddypress-share'); ?></li>
                                <li><?php esc_html_e('Multiple Group Header Layout', 'buddypress-share'); ?></li>
                                <li><?php esc_html_e('BuddyPress Customization Options', 'buddypress-share'); ?></li>
                                <li><?php esc_html_e('BuddyPress Extra Widgets', 'buddypress-share'); ?></li>
            ...
            <div class="wbcom-demo-content-wrap">
                <div class="wbcom-demo-importer">
                    <div class="container">
                        <div class="wbcom-image-wrapper">
                            <img src="<?php echo esc_url( plugin_url . 'admin/wbcom/assets/imgs/learnmate.jpg' ); ?>" alt="Avatar" class="image" style="width:100%">
                        </div>
                        <div class="wbcom-demo-title">
                            ...
                            <ul class="wbcom_theme_features_list">
                                ...
                                <li><?php esc_html_e('Grid And List Layout', 'buddypress-share'); ?></li>
                                <li><?php esc_html_e('Learndash/LifterLMS Extra Widgets', 'buddypress-share'); ?></li>
                                <li><?php esc_html_e('Unparalleled Course Layout', 'buddypress-share'); ?></li>
                                <li><?php esc_html_e('Awesome Learndash/LifterLMS Pages', 'buddypress-share'); ?></li>
            ...
            <div class="wbcom-demo-content-wrap">
                <div class="wbcom-demo-importer">
                    <div class="container">
                        <div class="wbcom-image-wrapper">
                            <img src="<?php echo esc_url( plugin_url . 'admin/wbcom/assets/imgs/storemate.jpg' ); ?>" alt="Avatar" class="image" style="width:100%">
                        </div>
                        <div class="wbcom-demo-title">
                            ...
                            <ul class="wbcom_theme_features_list">
                                ...
                                <li><?php esc_html_e('Awesome WooCommerce Pages', 'buddypress-share'); ?></li>
                                <li><?php esc_html_e('Grid And List Layout', 'buddypress-share'); ?></li>
            ...
            <div class="wbcom-demo-content-wrap">
                <div class="wbcom-demo-importer">
                    <div class="container">
                        <div class="wbcom-image-wrapper">
                            <img src="<?php echo esc_url( plugin_url . 'admin/wbcom/assets/imgs/jobmate.jpg '); ?>" alt="Avatar" class="image" style="width:100%">
                        </div>
                        <div class="wbcom-demo-title">
            ...
            <div class="wbcom-demo-content-wrap">
                <div class="wbcom-demo-importer">
                    <div class="container">
                        <div class="wbcom-image-wrapper">
                            <img src="<?php echo esc_url( plugin_url . 'admin/wbcom/assets/imgs/buddyx.jpg' ); ?>" alt="Avatar" class="image" style="width:100%">
                        </div>
                        <div class="wbcom-demo-title">
                            ...
                            <div class="wbcom-middle">
                                <a target="_blank" href="https://wbcomdesigns.com/downloads/buddyx-theme/?utm_source=wporg&utm_medium=plugins&utm_campaign=bp" class="wbcom-button wbcom-purchase"><?php esc_html_e('View', 'buddypress-share'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="wbcom-demo-content-wrap">
                <div class="wbcom-demo-importer">
                    <div class="container">
                        <div class="wbcom-image-wrapper">
                            <img src="<?php echo esc_url( plugin_url . 'admin/wbcom/assets/imgs/knowx.jpg' ); ?>" alt="Avatar" class="image" style="width:100%">
                        </div>
                        <div class="wbcom-demo-title">
                            <h2><?php esc_html_e('KnowX Theme', 'buddypress-share'); ?></h2>
                            <ul class="wbcom_theme_features_list">
                                <li><?php esc_html_e('Free WordPress Theme', 'buddypress-share'); ?></li>
                                <li><?php esc_html_e('Site Ready In One-Click', 'buddypress-share'); ?></li>
                                <li><?php esc_html_e('Create Knowledge base', 'buddypress-share'); ?></li>
                                <li><?php esc_html_e('Suitable for All Devices', 'buddypress-share'); ?></li>
                            </ul>
                            <div class="wbcom-middle">
                                <a target="_blank" href="https://wbcomdesigns.com/downloads/knowx-theme/?utm_source=wporg&utm_medium=plugins&utm_campaign=bp" class="wbcom-button wbcom-purchase"><?php esc_html_e('View', 'buddypress-share'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
