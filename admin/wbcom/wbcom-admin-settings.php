...
if ( ! class_exists( 'Wbcom_Admin_Settings' ) ) {
	...
	class Wbcom_Admin_Settings {
		...
		public function wbcom_do_plugin_activate( $slug ) {
			$plugin_file_path = $this->get_plugin_file_path_from_slug( $slug );
		...
		public function wbcom_all_free_plugins() {
			$free_plugins = array(
				'0'  => array(
					'name'        => esc_html__( 'Custom Font Uploader', 'woocommerce-price-quote-pro' ),
					'slug'        => 'custom-font-uploader',
					'description' => esc_html__( 'It also allows you to upload your own custom font to your site and use them using custom css.', 'woocommerce-price-quote-pro' ),
					'status'      => $this->wbcom_plugin_status( 'custom-font-uploader' ),
					'wp_url'      => 'https://wordpress.org/plugins/custom-font-uploader/',
					'icon'        => 'fa fa-upload',
				),
				'1'  => array(
					'name'        => esc_html__( 'BuddyPress Activity Filter', 'woocommerce-price-quote-pro' ),
					'slug'        => 'bp-activity-filter',
					'description' => esc_html__( 'Admin can set default and customised activities to be listed on front-end.', 'woocommerce-price-quote-pro' ),
					'status'      => $this->wbcom_plugin_status( 'bp-activity-filter' ),
					'wp_url'      => 'https://wordpress.org/plugins/bp-activity-filter/',
					'icon'        => 'fa fa-filter',
				),
				'2'  => array(
					'name'        => esc_html__( 'BuddyPress Activity Social Share', 'woocommerce-price-quote-pro' ),
					'slug'        => 'bp-activity-social-share',
					'description' => esc_html__( 'This plugin allows anyone easily share BuddyPress Activites on major social media (Facebook, Twitter, Google+, Linkedin ).', 'woocommerce-price-quote-pro' ),
					'status'      => $this->wbcom_plugin_status( 'bp-activity-social-share' ),
					'wp_url'      => 'https://wordpress.org/plugins/bp-activity-social-share/',
					'icon'        => 'fa fa-share-alt',
				),
				'3'  => array(
					'name'        => esc_html__( 'BuddyPress Create Group Type', 'woocommerce-price-quote-pro' ),
					'slug'        => 'bp-create-group-type',
					'description' => esc_html__( 'It will help to create group type for BuddyPress Groups.', 'woocommerce-price-quote-pro' ),
					'status'      => $this->wbcom_plugin_status( 'bp-create-group-type' ),
					'wp_url'      => 'https://wordpress.org/plugins/bp-create-group-type/',
					'icon'        => 'fa fa-sitemap',
				),
				'4'  => array(
					'name'        => esc_html__( 'BuddyPress Member Reviews', 'woocommerce-price-quote-pro' ),
					'slug'        => 'bp-user-profile-reviews',
					'description' => esc_html__( 'This plugin allows only site members to add reviews to the buddypress members on the site and even rate the member’s profile out of 5 points with multiple review criteria.', 'woocommerce-price-quote-pro' ),
					'status'      => $this->wbcom_plugin_status( 'bp-user-profile-reviews' ),
					'wp_url'      => 'https://wordpress.org/plugins/bp-user-profile-reviews/',
					'icon'        => 'fa fa-user',
				),
				'5'  => array(
					'name'        => esc_html__( 'BuddyPress Group Reviews', 'woocommerce-price-quote-pro' ),
					'slug'        => 'review-buddypress-groups',
					'description' => esc_html__( 'This plugin allows the BuddyPress Members to give reviews to the BuddyPress groups on the site. The review form allows the users to give text review, even rate the group on the basis of multiple criterias.', 'woocommerce-price-quote-pro' ),
				...
				'6'  => array(
					'name'        => esc_html__( 'BuddyPress Favorite Notification', 'woocommerce-price-quote-pro' ),
					'slug'        => 'bp-favorite-notification',
					'description' => esc_html__( 'BuddyPress Favorite Notification adds a notification for BuddyPress activity.', 'woocommerce-price-quote-pro' ),
				...
				'7'  => array(
					'name'        => esc_html__( 'Custom Email Options', 'woocommerce-price-quote-pro' ),
					'slug'        => 'custom-email-options',
					'description' => esc_html__( 'Override default email options of Worpdress.', 'woocommerce-price-quote-pro' ),
					'status'      => $this->wbcom_plugin_status( 'custom-email-options' ),
					'wp_url'      => 'https://wordpress.org/plugins/custom-email-options/',
					'icon'        => 'fa fa-2x fa-at',
				),
				'8'  => array(
					'name'        => esc_html__( 'BuddyPress Checkins', 'woocommerce-price-quote-pro' ),
					'slug'        => 'bp-check-in',
					'description' => esc_html__( 'This plugin allows BuddyPress members to share their location when they are posting activities, you can add places where you visited, nearby locations based on google places.', 'woocommerce-price-quote-pro' ),
					'status'      => $this->wbcom_plugin_status( 'bp-check-in' ),
					'wp_url'      => 'https://wordpress.org/plugins/bp-check-in/',
					'icon'        => 'fa fa-2x fa fa-map-marker',
				),
				'9'  => array(
					'name'        => esc_html__( 'BuddyPress Job Manager', 'woocommerce-price-quote-pro' ),
					'slug'        => 'bp-job-manager',
					'description' => esc_html__( 'Incorporates BuddyPress with the WP Job Manager plugin by creating specific tabs in employer’s and candidate’s profiles.', 'woocommerce-price-quote-pro' ),
				...
				'10' => array(
					'name'        => esc_html__( 'BuddyPress user ToDo List', 'woocommerce-price-quote-pro' ),
					'slug'        => 'bp-user-to-do-list',
					'description' => esc_html__( 'This plugin allows you to create your personal task list with timestamp. You can mark them complete when you are done with them. It will also send reminder when you have any overdue task.', 'woocommerce-price-quote-pro' ),
				...
				'11' => array(
					'name'        => esc_html__( 'Shortcodes for BuddyPress', 'woocommerce-price-quote-pro' ),
					'slug'        => 'shortcodes-for-buddypress',
					'description' => esc_html__( 'This plugin will add an extended feature to the big name “BuddyPress” that will generate Shortcode for Listing Activity Streams , Members and Groups on any post/page in website.', 'woocommerce-price-quote-pro' ),
				...
				'12' => array(
					'name'        => esc_html__( 'Woo Open Graph', 'woocommerce-price-quote-pro' ),
					'slug'        => 'woo-open-graph',
					'description' => esc_html__( 'This plugin will add an extended feature to the big name “WooCommerce” that will adds well executed and accurate Open Graph Meta Tags to your site with title,description and WooCommerce featured image.', 'woocommerce-price-quote-pro' ),
					'status'      => $this->wbcom_plugin_status( 'woo-open-graph' ),
					'wp_url'      => 'https://wordpress.org/plugins/woo-open-graph/',
					'icon'        => 'fa fa-bar-chart',
				),
				'13' => array(
					'name'        => esc_html__( 'BuddyPress Lock', 'woocommerce-price-quote-pro' ),
					'slug'        => 'lock-my-bp',
					'description' => esc_html__( 'This plugin allows the administrator to lock the certain parts of their site. It help to create private BuddyPress community by locking certain BuddyPress Components, WordPress Pages, Custom Post Types for public view without using any membership plugin.', 'woocommerce-price-quote-pro' ),
					'status'      => $this->wbcom_plugin_status( 'lock-my-bp' ),
					'wp_url'      => 'https://wordpress.org/plugins/lock-my-bp/',
					'icon'        => 'fa fa-2x fa-lock',
				),
				'14' => array(
					'name'        => esc_html__( 'Woo Audio Preview', 'woocommerce-price-quote-pro' ),
					'slug'        => 'woo-audio-preview',
					'description' => esc_html__( 'This plugin Allows playing the audio files in sample mode to prevent unauthorized downloading of the audio files. It helps to display sample files at single product page.', 'woocommerce-price-quote-pro' ),
				...
				'15' => array(
					'name'        => esc_html__( 'WordPress System Log', 'woocommerce-price-quote-pro' ),
					'slug'        => 'wp-system-log',
					'description' => esc_html__( 'This plugin helps administrators of the site see their environment on which the site is currently running that includes WordPress environment, tha database it requires, Server Environment and the plugins installed and activated on the site.', 'woocommerce-price-quote-pro' ),
					'status'      => $this->wbcom_plugin_status( 'wp-system-log' ),
					'wp_url'      => 'https://wordpress.org/plugins/wp-system-log/',
					'icon'        => 'fa fa-file-text',
				),
				'16' => array(
					'name'        => esc_html__( 'BP Post From Anywhere', 'woocommerce-price-quote-pro' ),
					'slug'        => 'bp-post-from-anywhere',
					'description' => esc_html__( 'This plugin will generate shortcode and widgets for post updates section for activities so you can post update from anywhere, it might be sidebar, some page or any template file.', 'woocommerce-price-quote-pro' ),
				...
				'17' => array(
					'name'        => esc_html__( 'Woo Document Preview', 'woocommerce-price-quote-pro' ),
					'slug'        => 'woo-document-preview',
					'description' => esc_html__( 'This will allow you to add document preview at single product page. Which helps to offer more better idea when you are selling ebooks, pdf or some documents.', 'woocommerce-price-quote-pro' ),
				...
				'18' => array(
					'name'        => esc_html__( 'WordPress Media Category', 'woocommerce-price-quote-pro' ),
					'slug'        => 'media-category',
					'description' => esc_html__( 'This plugin helps administrators of the site categorize their wordpress media.', 'woocommerce-price-quote-pro' ),
					'status'      => $this->wbcom_plugin_status( 'media-category' ),
					'wp_url'      => 'https://wordpress.org/plugins/media-category/',
					'icon'        => 'fa fa-picture-o',
				),
				'19' => array(
					'name'        => esc_html__( 'Woo Price Quotes', 'woocommerce-price-quote-pro' ),
					'slug'        => 'woo-price-quote-inquiry',
					'description' => esc_html__( 'This plugin helps in quoting the products that admin wishes to hide its purchasing details.', 'woocommerce-price-quote-pro' ),
					'status'      => $this->wbcom_plugin_status( 'woo-price-quote-inquiry' ),
					'wp_url'      => 'https://wordpress.org/plugins/woo-price-quote-inquiry/',
					'icon'        => 'fa fa-usd',
				),
				'20' => array(
					'name'        => esc_html__( 'EDD Service Extended', 'woocommerce-price-quote-pro' ),
				...
				'21' => array(
					'name'        => esc_html__( 'WB Ads Rotator with Split Test', 'woocommerce-price-quote-pro' ),
					'slug'        => 'wb-ads-rotator-with-split-test',
					'description' => esc_html__( 'This plugin is designed for the SPLIT TESTING, you can check performance of your ads layout and on the basis of them you can select one of them for your regular use.', 'woocommerce-price-quote-pro' ),
		...
		public function wbcom_all_paid_plugins() {
			$paid_plugins = array(
				'0' => array(
					'name'         => esc_html__( 'BuddyPress Moderation Pro', 'woocommerce-price-quote-pro' ),
					'description'  => esc_html__( 'BuddyPress Community Moderation offers a solution for site owners to keep their communities straight. With community policing strategy, members of the community have an option for moderation sitewide by attaching flags to content created within the various components.', 'woocommerce-price-quote-pro' ),
					'download_url' => 'https://wbcomdesigns.com/downloads/buddypress-moderation-pro/',
					'icon'         => 'fa fa-exclamation-triangle',
				),
				'1' => array(
					'name'         => esc_html__( 'BuddyPress Polls', 'woocommerce-price-quote-pro' ),
					'description'  => esc_html__( 'Use BuddyPress Polls plugin to create polls inside the activity, let your user response to your polls. Members can create pools like activities, easily votes on them.', 'woocommerce-price-quote-pro' ),
					'download_url' => 'https://wbcomdesigns.com/downloads/buddypress-polls/',
					'icon'         => 'fa fa-bar-chart',
				),
				'2' => array(
					'name'         => esc_html__( 'BuddyPress Resume Manager', 'woocommerce-price-quote-pro' ),
					'description'  => esc_html__( 'BuddyPress Resume Manager adds a separate BuddyPress Resume menu at a user’s BuddyPress Profile Page to display individual member resume. We have added predefined fields for the resumes and site admin and enable and disable them.', 'woocommerce-price-quote-pro' ),
					'download_url' => 'https://wbcomdesigns.com/downloads/buddypress-resume-manager/',
					'icon'         => 'fa fa-file',
				),
				'3' => array(
					'name'         => esc_html__( 'BuddyPress Profanity', 'woocommerce-price-quote-pro' ),
					'description'  => esc_html__( 'Use BuddyPress Profanity plugin to censor content in your community! Easily Censor all the unwanted words in activities, private messages contents by specifying a list of keywords to be filtered.', 'woocommerce-price-quote-pro' ),
					'download_url' => 'https://wbcomdesigns.com/downloads/buddypress-profanity/',
					'icon'         => 'fa fa-hand-peace-o',
				),
				'4' => array(
					'name'         => esc_html__( 'BuddyPress Private Community Pro', 'woocommerce-price-quote-pro' ),
					'description'  => esc_html__( 'This plugin offers a lockdown for BuddyPress Component and will ask users to log in go further to check profile or any other protected details.', 'woocommerce-price-quote-pro' ),
					'download_url' => 'https://wbcomdesigns.com/downloads/woocommerce-price-quote/',
					'icon'         => 'fa fa-user-times',
				),
				'5' => array(
					'name'         => esc_html__( 'BuddyPress Profile Pro', 'woocommerce-price-quote-pro' ),
					'description'  => esc_html__( 'This plugin gives you the power to extend BuddyPress Profiles with repeater fields and groups. You can easily add multiple field groups and display them at member’s profile.', 'woocommerce-price-quote-pro' ),
			...
			if ( ! wp_script_is( 'wbcom-admin-setting-js', 'enqueued' ) ) {
				...
				wp_localize_script(
					...
					array(
						...
						'activate_text'    => esc_html__( 'Activate', 'woocommerce-price-quote-pro' ),
						'deactivate_text'  => esc_html__( 'Deactivate', 'woocommerce-price-quote-pro' ),
					)
				);
		...
		public function wbcom_admin_additional_pages() {
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Components', 'woocommerce-price-quote-pro' ),
				esc_html__( 'Components', 'woocommerce-price-quote-pro' ),
				'manage_options',
				'wbcom-plugins-page',
			...
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Themes', 'woocommerce-price-quote-pro' ),
				esc_html__( 'Themes', 'woocommerce-price-quote-pro' ),
				'manage_options',
				'wbcom-themes-page',
			...
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Support', 'woocommerce-price-quote-pro' ),
				esc_html__( 'Support', 'woocommerce-price-quote-pro' ),
				'manage_options',
				'wbcom-support-page',
		...
		public function wbcom_admin_setting_header_html() {
			...
			<div id="wb_admin_header" class="wp-clearfix">
				...
				<div id="wb_admin_logo">
					<img src="<?php echo WB_AJAX_FILTER_URL . 'admin/wbcom/assets/imgs/logowbcom.png'; ?>">
					...
					<ul>
						<li class="wb_admin_nav_item <?php echo esc_attr( $settings_active ); ?>">
							<a href="<?php echo get_admin_url() . 'admin.php?page=wbcomplugins'; ?>" id="wb_admin_nav_trigger_settings">
								...
								<h4><?php esc_html_e( 'Settings', 'woocommerce-price-quote-pro' ); ?></h4>
							</a>
						</li>
						<li class="wb_admin_nav_item <?php echo esc_attr( $plugin_active ); ?>">
							<a href="<?php echo get_admin_url() . 'admin.php?page=wbcom-plugins-page'; ?>" id="wb_admin_nav_trigger_extensions">
								...
								<h4><?php esc_html_e( 'Components', 'woocommerce-price-quote-pro' ); ?></h4>
							</a>
						</li>
						<li class="wb_admin_nav_item <?php echo esc_attr( $theme_active ); ?>">
							<a href="<?php echo get_admin_url() . 'admin.php?page=wbcom-themes-page'; ?>" id="wb_admin_nav_trigger_themes">
								...
								<h4><?php esc_html_e( 'Themes', 'woocommerce-price-quote-pro' ); ?></h4>
							</a>
						</li>
						<li class="wb_admin_nav_item <?php echo esc_attr( $support_active ); ?>">
							<a href="<?php echo get_admin_url() . 'admin.php?page=wbcom-support-page'; ?>" id="wb_admin_nav_trigger_support">
								...
								<h4><?php esc_html_e( 'Support', 'woocommerce-price-quote-pro' ); ?></h4>
							</a>
						</li>
